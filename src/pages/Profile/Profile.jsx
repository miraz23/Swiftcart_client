...
function Profile() {
  ...
  const [image, setImage] = useState(currentUser?.photoURL || '/logo.png');
  ...
  useEffect(() => {
    document.title = 'Swift Cart | Profile';
  }, []);

  // keep local state in sync with auth user (e.g., after Google login)
  useEffect(() => {
    if (currentUser) {
      setImage(currentUser.photoURL || '/default.png');
  ...
  return (
    <Wrapper className='sc'>
      ...
      <form onSubmit={handleSubmitName}>
        ...
        <LoadingButton disabled={loading} type='submit' className='btn submit-btn'>
          save
        </LoadingButton>
      </form>
      <div className='seperator'>
